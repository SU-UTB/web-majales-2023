...
const Landing = () => {
  return (
    ...
    >
      <VerticalSocials />
      <div className="mx-auto main-info md:w-4/5">
        <img src={homeMajalesLogo} alt="Majáles logo" className="mx-auto" />
        <div className="flex flex-col items-end px-4 -mt-8 text-right sm:px-20 md:px-16 2xl:px-0 sm:-mt-20 md:-mt-20 lg:-mt-36 2xl:-mt-40 2xl:w-4/5">
          <LandingDate />
